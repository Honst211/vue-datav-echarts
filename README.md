...
该项目是根据大佬**奔跑的蜗牛**他的项目进行修改的，个人仅仅只是在其基础上修改了几个组件而已，有兴趣可以去到大佬国内的git页面去看看，非常感谢大佬，让我学习到了很多，大佬的git地址:https://gitee.com/MTrun/big-screen-vue-datav
...
| common/ecchart，flexible | 全局封装的 ECharts 和 flexible 插件代码（适配屏幕尺寸，可定制化修改）     |
| common/world | 封装echarts世界地图的的模板信息，将中国区域给细分化 |
...
该项目相当于个人对于datav插件和echarts学习的作品，再次感谢大佬的代码，其中动态渲染图表和复用图表组件的代码让我受益良多，给刚开始学习前端的我打开了一个新的窗户
